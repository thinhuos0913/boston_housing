...
- Advanced regression technique like XGBoost Regressor
## Metric
Submissions are evaluated on Root-Mean-Squared-Error (RMSE) between the predicted value and the observed sales price.
